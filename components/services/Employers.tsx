            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
                  We provide complete end-to-end recruitment services on a
                  per-candidate hiring model. Our focus is to help organizations
                  hire the right talent efficiently, affordably, and with
      ...
      <section className="py-20 bg-secondary text-white overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Partner with Manuvance Talent Solutions for professional,
            transparent, and reliable recruitment services.
          </p>
