            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
                  We help job seekers find genuine private and corporate job
                  opportunities across India. Our team ensures proper
                  communication, interview updates, and guidance throughout the
                  hiring process.
                </p>
      ...
      <section className="py-20 bg-primary text-primary-foreground overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-primary-foreground/90 mb-8">
            Let us help you find the right opportunity with transparency and
