            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
                  Our hiring model is designed to make recruitment easy and cost-effective.
                  We work on a per-candidate hiring basis with clear pricing, special packages
                  for bulk hiring, and complete transparency at every stage.
                </p>
      ...
      <section className="py-20 bg-secondary text-white overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Choose a recruitment approach that saves time, cost, and effort while
            ensuring quality hiring.
          </p>
